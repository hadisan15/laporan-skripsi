        ...
        <!DOCTYPE html>
          <html lang="en">
            ...
            <body>
              ...
              <h2 class="title">LAPORAN DATA PESEPEDA TOUR DE LOKSADO 2022<br>ASAL ' . strtoupper($zoneName['nama_asaldaerah']) . '</h2>
              <br>
...
foreach ($cyclistPerZone as $cpz) {
  $html .= '
                <tr>
                  ...
                  <td>' . $cpz["id"] . '</td>
                  <td>' . $cpz["nama"] . '</td>
                  <td>' . $cpz["nama_asaldaerah"] . '</td>
                  <td>' . $cpz["nama_provinsi"] . '</td>
                  <td>' . $cpz["jenis_transportasi"] . '</td>
                </tr>';
}
$html .= '
              </table>
