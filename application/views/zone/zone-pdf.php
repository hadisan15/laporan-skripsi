          ...
          <html lang="en">
            ...
            <body>
              ...
              <table border="1" cellpadding="10" cellspacing="0" class="table">
                <tr>
                  <th scope="col">#</th>
                  <th scope="col">Nama Asal Wilayah</th>
                  <th scope="col">Jumlah Pesepeda</th>
                  <th scope="col" style="width: 200px">Gambar Asal Wilayah</th>
                </tr>';
$i = 1;
foreach ($zone as $z) {
  $html .= '
                <tr>
                  <td>' . $z["kode_asaldaerah"] . '</td>
                  <td>' . $z["nama_asaldaerah"] . '</td>
                  <td>' . $z["jlh"] . '</td>
                  <td>
                  <img src="' . base_url('assets/img/zone/' . $z["gambar"]) . '" width="150px">
                  </td>
                </tr>';
}
$html .= '
