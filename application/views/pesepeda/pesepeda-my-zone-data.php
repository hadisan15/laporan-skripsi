      ...
      <div class="row">
        <div class="col-sm">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item active">My Zone Data</li>
            </ol>
          </nav>
        </div>
      </div>
        ...
        <div class="col">
          <div class="row">
            <div class="col-md-6 mb-2">
              <a href="<?= base_url('pesepeda/editMyZoneData/') . $myCyclistData['id']; ?>">
                <button type="button" class="btn btn-primary me-1 text-white"><i class="fa-solid fa-pen"></i> Edit My Cyclist Zone</button>
              </a>
            </div>
          </div>
          <div class="card">
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                <div class="card mt-3 mb-3 me-3">
                  <div class="card-header fw-bolder">
                    <h5 class="card-title">Zone Data</h5>
                  </div>
                  <div class="card-body">
                    <ol class="list-group mb-3">
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 ">
                          Zone
                          <?php if ($myZoneData['nama_asaldaerah'] === "") { ?>
                            <div class="fw-bold">-</div>
                          <?php } else { ?>
                            <div class="fw-bold"><?= $myZoneData['nama_asaldaerah']; ?></div>
                          <?php } ?>
                        </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 ">
                          Province
                          <div class="fw-bold"><?= $myZoneData['nama_provinsi']; ?></div>
                        </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 ">
                          Transportation
                          <?php if ($myZoneData['jenis_transportasi'] === "") { ?>
                            <div class="fw-bold">-</div>
                          <?php } else { ?>
                            <div class="fw-bold"><?= $myZoneData['jenis_transportasi']; ?></div>
                          <?php } ?>
                        </div>
                      </li>
                    </ol>
