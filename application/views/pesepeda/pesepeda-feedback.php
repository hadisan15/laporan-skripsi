        ...
        <div class="col">
          <div class="row">
            <div class="col-md-6 mb-2">
              <a href="<?= base_url('pesepeda/editMyFeedback/') . $myCyclistData['id']; ?>">
                <button type="button" class="btn btn-primary me-1 text-white"><i class="fa-solid fa-pen"></i> Edit My Feedback</button>
              </a>
            </div>
          </div>
          <div class="card">
                  ...
                  <div class="card-body">
                    <ol class="list-group mb-3">
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 ">
                          Rate
                          <?php if ($myFeedbackData['nilai'] === "") { ?>
                            <div class="fw-bold">-</div>
                          <?php } else { ?>
                            <div class="fw-bold"><?= $myFeedbackData['nilai']; ?></div>
                          <?php } ?>
                        </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 ">
                          Comment
                          <div class="fw-bold"><?= $myFeedbackData['komentar']; ?></div>
                        </div>
                      </li>
                    </ol>
                  </div>
