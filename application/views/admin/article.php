    ...
    <div class="container-fluid" style="min-height: 450px;">
      ...
      <div class="card px-2 py-2" style="min-height: 260px;">
        <div class="row">
          <div class="col">
            <a href="<?= base_url('admin/articleCreate'); ?>" class="btn btn-primary mb-3">Add Article</a>
          </div>
        </div>
            ...
            <div class="col-md-4 mb-3">
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><?= substr($row['isi'], 0, 40) ?>...</p>
                  <a href="<?= base_url('admin/articleDetail/' . $row['slug']); ?>" class="btn btn-primary">Manage Article</a>
                </div>
              </div>
            </div>
          <?php endforeach; ?>
