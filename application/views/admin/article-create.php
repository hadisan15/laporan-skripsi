    ...
    <div class="container-fluid" style="min-height: 450px;">
      ...
      <div class="card px-2 py-2" style="min-height: 260px;">
        <div class="row">
          <div class="col">
            <?= form_open_multipart('admin/articleCreate'); ?>
            <div class="row mb-3">
              <label for="judul" class="col-sm-3 col-form-label">Title</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="judul" name="judul" placeholder="Insert Article Title">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <textarea class="form-control" id="isi" name="isi" placeholder="Insert Article Content"></textarea>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <div class="row">
                  <div class="col-sm-3">
                    <img src="<?= base_url('assets/img/article/default-article-img.jpg'); ?>" alt="" class="img-thumbnail">
                  </div>
                  <div class="col-sm-9">
